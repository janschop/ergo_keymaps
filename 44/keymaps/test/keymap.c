...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    _______,   KC_F1,      KC_F2,      KC_F3,   KC_F4,      KC_F5,    KC_F6  , ALGR(KC_7), ALGR(KC_8), ALGR(KC_9),    ALGR(KC_0), _______,        
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX,  lft_dsktp, G(KC_TAB), rght_dsktp, XXXXXXX, XXXXXXX,
    TO(0)  , KC_BTN4, KC_BTN1, KC_WH_U, KC_BTN2, KC_BTN5,    XXXXXXX, LGUI(KC_D),   KC_MS_U,    XXXXXXX, XXXXXXX,   TO(0),    
