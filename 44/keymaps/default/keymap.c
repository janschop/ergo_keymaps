...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_PSCR, SFT_T(KC_Z), ALT_T(KC_X),    KC_C,    KC_V,   KC_B,    KC_N  ,          KC_M, KC_COMM,  KC_DOT, SFT_T(KC_SLSH), KC_BTN3,
          QK_RBT, QK_BOOT, KC_BSPC, OSL(1),    LT(2, KC_SPC), OSL(3), DM_PLY1, DM_PLY2
    ),
    ...
    _______, _______,  KC_DELETE, _______,    _______, _______, _______, _______
    ),
    ...
    _______, _______, KC_DELETE, _______,    _______,TO(4) , _______,     _______            
    ),
